...
namespace RemeSnes.Hardware.Audio
{
    ...
    /// and an internal clock of 3.072 MHz. This is 96 cycles between each 32kHz sample.
    /// </summary>
    internal class Dsp
    {
        ...
        private static readonly ushort[] RateTable = new ushort[]
        ...
        // Size 0x200
        private static readonly ushort[] Gauss = new ushort[] {
